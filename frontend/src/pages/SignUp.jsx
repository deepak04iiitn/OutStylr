...
export default function SignUpFashionMirror() {
  ...
  return (
    <div className="min-h-screen bg-slate-900 overflow-hidden relative">
      ...
      {/* Main Content - Fashion Mirror Design (SWAPPED LAYOUT) */}
      <div 
      ...
      >
        ...
        >
          {/* Fashion Mirror Container - REVERSED ORDER */}
          <div className="relative grid lg:grid-cols-2 gap-8 items-center perspective-1000">
            
            {/* LEFT SIDE - Fashion Mirror Form (MOVED TO LEFT) */}
            <motion.div 
              ...
              >
                ...
                <div className="relative z-10 p-6 sm:p-8">
                  ...
                  >
                    ...
                    <p className="text-purple-300">Create your fashion identity</p>
                  </motion.div>
            ...
            {/* RIGHT SIDE - Style Showcase (MOVED TO RIGHT) */}
            <motion.div 
            ...
            >
              ...
              <div className="relative bg-gradient-to-br from-slate-800/60 to-purple-900/40 backdrop-blur-2xl rounded-[2rem] p-8 lg:p-12 border border-purple-500/30 overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  >
                    Start Your{' '}
                    <span className="block">Fashion Journey</span>
                    Today
                  </motion.h2>
                  ...
                  <motion.p 
                    ...
                    transition={{ duration: 3, repeat: Infinity }}
                  >
                    Join OutStylr and become part of a fashion revolution that eliminates the frustration of "link please?" forever.
                  </motion.p>

                  {/* Fashion Benefits */}
                  <div className="space-y-4">
                    {[
                      { icon: '🌟', title: 'Discover Collections', desc: 'Explore curated fashion collections' },
                      { icon: '⚡', title: 'Instant Shopping', desc: 'Shop complete looks directly' },
                      { icon: '👥', title: 'Fashion Community', desc: 'Connect with style enthusiasts' }
                    ].map((benefit, index) => (
                      <motion.div
                        key={benefit.title}
